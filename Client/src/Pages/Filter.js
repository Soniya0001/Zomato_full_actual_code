...
class Filter extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            ...
            .then(res => {
                this.setState({ restaurants: res.data.restaurant, mealtype: int })
            })
    ...
    handleLocation = (val) => {
        ...
        axios({
            ...
            .then(res => {
                this.setState({ restaurants: res.data.restaurant, loca })
            })
            .catch((err => console.log(err)))
    ...
    handleCuisine = (i) => {
        ...
        axios({
            ...
            .then(res => {
                this.setState({ restaurants: res.data.restaurant, Cuisine: tempCuisine })
            })
            .catch((err => console.log(err)))
...
//handle page
    ...
    render() {
        ...
        const { loc, restaurants, mealt } = this.state;
        ...
        return (
            <div>
                ...
                <div class="container mb-5">
                    {/* {console.log(mealt)} */}
                    <h2 class="filter-heading mt-3">{mealt.name} Places </h2>
                    ...
                    <div class="filter-box mt-2 pb-4">
                        ...
                        <input type="radio" id="ltoh" name="Sort" value="Price low to high" onClick={() => this.handleSort(1)} /> <label for="ltoh" class="filter-content">Price low to high</label> <br />
                        <input type="radio" id="htol" name="Sort" value="Price high to low" onClick={() => this.handleSort(-1)} /> <label for="htol" class="filter-content">Price high to low</label> <br />
                    ...
                    <div class="result-box mt-2">
                        ...
                        {restaurants.length != 0 ?
                            restaurants.map((res) => {
                                console.log(res)
                                    ...
                                    return (<div class="results" onClick={() => this.handleNavigate(res._id)}>
                                        <div class="d-flex">
                                            <div class="lt-box">
                        ...
                        {/* <div class="mt-5">
                            <ul class="pagination justify-content-center">
                                ...
                                <li class="page-item"><a class="page-link" href="#" onClick={() => this.handlePage(1)}>1</a></li>
                                <li class="page-item"><a class="page-link" href="#" onClick={() => this.handlePage(2)}>2</a></li>
                                <li class="page-item"><a class="page-link" href="#" onClick={() => this.handlePage(3)}>3</a></li>
                                <li class="page-item"><a class="page-link" href="#" onClick={() => this.handlePage(4)}>4</a></li>
                                <li class="page-item"><a class="page-link" href="#" onClick={() => this.handlePage(5)}>5</a></li>
                                <li class="page-item">
                                    <a class="page-link" href="#">
                                        <span>{' >'} </span>
                                    </a>
